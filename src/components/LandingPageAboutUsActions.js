...
LandingPageAboutUsActions.propTypes = {
  visible: PropTypes.bool.isRequired,
  setCreateModalData: PropTypes.func.isRequired,
  setRunUseEffect: PropTypes.func.isRequired,
  setCreateModalVisible: PropTypes.func.isRequired,
  createModalData: PropTypes.object.isRequired,
