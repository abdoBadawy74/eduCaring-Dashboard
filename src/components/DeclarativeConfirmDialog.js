...
DeclarativeConfirmDialog.propTypes = {
  confirmDialogVisible: PropTypes.any,
  setConfirmDialogVisible: PropTypes.func.isRequired,
  users: PropTypes.array.isRequired,
  eventDayId: PropTypes.any.isRequired,
  notificationType: PropTypes.string.isRequired,
  speakers: PropTypes.array,
  spIndex: PropTypes.any,
};
